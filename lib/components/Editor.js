...
var _StaticToolbar = require('./Toolbar/StaticToolbar');

var _StaticToolbar2 = _interopRequireDefault(_StaticToolbar);
...
var _default = function (_Component) {
  ...
  _createClass(_default, [{
    ...
    key: 'renderStaticToolbar',
    value: function renderStaticToolbar(props) {
      return _react2.default.createElement(_StaticToolbar2.default, props);
    }
  }, {
    key: 'renderSidebar',
    ...
    value: function uploadFile(file, selection) {
      ...
      if (uploadImageAsync !== undefined) {
        ...
        uploadImageAsync(file).then(function (data) {
          ...
          var imageData = { src: data.src, srcSet: srcSet, type: 'image', caption: data.caption || '', title: '', alt: '' };
          _this2.onChange((0, _insertDataBlock2.default)(editorState, imageData, selection));
          _this2.setState({ uploading: false });
        }).catch(function (error) {
          _this2.onChange((0, _insertDataBlock2.default)(editorState, null, selection));
          _this2.setState({ uploading: false });
        });
      } else {
